...
var Member = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(Member, [{
    ...
    value: function processMember() {
      ...
      this.isRemovable = _util.default.isRemovable(this.isSelf, this.isGuest, this.isInMeeting, this.type); // must occur after self, device, meeting, mute status, and type properties are calculated
    ...
    value: function processIsContentSharing(participant, sharingId) {
      if (_util.default.isUser(participant)) {
        this.isContentSharing = _util.default.isSame(participant, sharingId);
      } else if (_util.default.isDevice(participant)) {
    ...
    value: function processIsSelf(participant, selfId) {
      if (_util.default.isUser(participant)) {
        this.isSelf = _util.default.isSame(participant, selfId);
      } else if (_util.default.isDevice(participant)) {
        this.isSelf = _util.default.isAssociatedSame(participant, selfId);
    ...
    value: function processIsHost(participant, hostId) {
      if (_util.default.isUser(participant)) {
        this.isHost = _util.default.isSame(participant, hostId);
      } else if (_util.default.isDevice(participant)) {
